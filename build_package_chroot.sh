...
echo "Server = http://mirror.arizona.edu/archlinux/core/os/$arch/" > /etc/pacman.d/mirrorlist
echo "Server = http://mirror.arizona.edu/archlinux/extra/os/$arch/" > /etc/pacman.d/mirrorlist
